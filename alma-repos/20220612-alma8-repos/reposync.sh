...
dnf reposync --repo powertools -a x86_64,noarch --newest-only --delete --downloadcomps --download-metadata
...
dnf reposync --repo epel-modular -a x86_64,noarch --newest-only --delete --downloadcomps --download-metadata
